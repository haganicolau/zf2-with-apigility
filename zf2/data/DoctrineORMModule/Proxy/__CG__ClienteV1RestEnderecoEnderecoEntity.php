...
namespace DoctrineORMModule\Proxy\__CG__\Cliente\V1\Rest\Endereco;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class EnderecoEntity extends \Cliente\V1\Rest\Endereco\EnderecoEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cliente\\V1\\Rest\\Endereco\\EnderecoEntity' . "\0" . 'id', '' . "\0" . 'Cliente\\V1\\Rest\\Endereco\\EnderecoEntity' . "\0" . 'logradouro', '' . "\0" . 'Cliente\\V1\\Rest\\Endereco\\EnderecoEntity' . "\0" . 'numero', '' . "\0" . 'Cliente\\V1\\Rest\\Endereco\\EnderecoEntity' . "\0" . 'cep', '' . "\0" . 'Cliente\\V1\\Rest\\Endereco\\EnderecoEntity' . "\0" . 'bairro', '' . "\0" . 'Cliente\\V1\\Rest\\Endereco\\EnderecoEntity' . "\0" . 'complemento'];
        }
